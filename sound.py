...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_secs', type=int, default=4, help='number of seconds of sound')
    parser.add_argument('--max_val', type=int, default=32, help='maximum number for random number partition instance')
    parser.add_argument('--problem_card', type=int, default=5, help='cardinality for number partition instance')
    ...
    parser.add_argument('--filename', type=str, default='curr_sound.wav', help='where to save file')
    ...
    sf.write(args.filename, sound, FREQ)
